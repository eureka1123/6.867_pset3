...
namespace GLOO {
RK4Pendulum::RK4Pendulum(float integration_step) {
  integration_step_ = integration_step;
  RK4_integrator_ = ForwardRK4Integrator<PendulumSystem, ParticleState>();
...
void RK4Pendulum::Update(double delta_time) {
