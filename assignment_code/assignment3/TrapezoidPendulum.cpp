...
namespace GLOO {
TrapezoidPendulum::TrapezoidPendulum(float integration_step) {
  integration_step_ = integration_step;
  trapezoid_integrator_ = ForwardTrapezoidIntegrator<PendulumSystem, ParticleState>();
...
void TrapezoidPendulum::Update(double delta_time) {
